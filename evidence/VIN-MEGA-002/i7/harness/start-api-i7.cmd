...
set VINOPS_API_PORT=4610
set VINOPS_DATABASE_URL=postgresql://postgres:vinops-i6-local-secret@127.0.0.1:55446/vinops_mega002_test
set VINOPS_AUTH_TOKEN_SECRET=vinops-mega002-i6-auth-secret-0123456789
set VINOPS_ALLOWED_ORIGINS=http://127.0.0.1:4611
...
"C:\Users\Duong Vinh\.cache\codex-runtimes\codex-primary-runtime\dependencies\node\bin\node.exe" --loader "./evidence/VIN-MEGA-002/i6/harness/pg-loader.mjs" "apps/api/dist/main.js" >> "evidence/VIN-MEGA-002/i6/api-i6.stdout.log" 2>> "evidence/VIN-MEGA-002/i6/api-i6.stderr.log"
